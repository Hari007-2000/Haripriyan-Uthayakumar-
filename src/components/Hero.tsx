      ...
      <div className="container relative z-10 px-4 py-20 mx-auto">
        <div className="max-w-4xl mx-auto text-center space-y-8 animate-in fade-in duration-1000">
          <h1 className="text-5xl md:text-7xl font-bold leading-tight">
            PhD Researcher in
            <span className="block text-gradient mt-2">Industrial Ecology & AI</span>
          </h1>
          
          <p className="text-xl md:text-2xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            Advancing sustainable manufacturing through artificial intelligence and circular economy principles
          </p>
